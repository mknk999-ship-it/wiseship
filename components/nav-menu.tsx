      ...
      {open &&
        createPortal(
          <div className="fixed inset-0 z-50">
            ...
            />
            <div className="absolute right-0 top-0 flex h-full w-64 max-w-[80vw] flex-col border-l border-zinc-700 bg-zinc-900 p-4 shadow-2xl">
              <div className="mb-4 flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => setOpen(false)}
                  aria-label="메뉴 닫기"
                  className="flex h-9 w-9 items-center justify-center rounded-lg text-zinc-400 transition hover:text-zinc-100"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="mt-auto border-t border-zinc-800 pt-4">
                ...
                <form action={logout} className="mt-2">
                  <button
                    type="submit"
                    className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-3 text-left text-sm font-medium text-zinc-300 transition hover:border-red-800 hover:text-red-300"
                  >
                    로그아웃
                  </button>
                </form>
